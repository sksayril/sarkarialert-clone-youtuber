...
const ResultsPage: React.FC = () => {
  ...
  useEffect(() => {
    const fetchResults = async () => {
      try {
        const response = await fetch("https://7cvccltb-3110.inc1.devtunnels.ms/admin/users/results");
        if (!response.ok) {
        ...
        setResults([
          ...
          {
            _id: "2",
            contentTitle: "UPSC Civil Services Final Result 2025",
            contentDescription: "Union Public Service Commission Civil Services Final Result 2025 has been announced.",
            createdAt: "2025-01-14T10:00:00Z",
            updatedAt: "2025-01-14T10:00:00Z"
          },
          {
            _id: "3",
            contentTitle: "Bihar Teacher Result 2025",
            contentDescription: "Bihar Teacher Recruitment Board Result 2025 has been declared.",
  ...
  return (
    <div className="max-w-4xl mx-auto py-8">
      <h1 className="text-3xl font-bold mb-6 text-center text-gray-800">Latest Results</h1>
